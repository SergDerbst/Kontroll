 ...
 *
 */
public class CountTestDataPreparerTest extends TestDataPreparerTest {

	public CountTestDataPreparerTest() {
		super(CountTestDataPreparer.newInstance(), TestStrategy.Count);
	}
