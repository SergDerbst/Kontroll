...
public class ContentLoadingService {
	...
	private List<ContentItem> verifyAndParseContent(final List<ScopedContent> scopedContents, final ContentLoadingContext contentDto) throws ContentException {
	...
	private List<ScopedContent> findValidContent(final List<ScopedContent> scopedContents, final ContentLoadingContext contentDto) {
	...
	private List<ContentItem> verifyAndParseContentItems(final ScopedContent scopedContent, final ContentLoadingContext contentDto) throws NoContentParserFoundException {
