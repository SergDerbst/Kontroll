package com.tmt.kontroll.ui.components.utils.content.editor.main;
...
@Button(ordinal = 2, position = ChildPosition.Bottom, name = "edit", events = {@Event(type = EventType.Click, handlers = {"prepareContentItemEdit, toggleContentItemEditor"})})
