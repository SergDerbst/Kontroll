...
public enum TestStrategy {
	...
	Exists,
	/**
	 * Test strategy to test whether the find and find all operations work.
	 * </p>
	 * <ul>
	 * <li><b>Db setup: </b>At least one entity exists in the data base.</li>
	 * <li><b>Test: </b>That all existing entities can be found.</li>
	 * <li><b>Db verification: </b>That data remains unchanged.</li>
	 * </ul>
	 */
	Find,
	/**
	 * Test strategy to test whether the save and save all operations work for new entities.
	 * </p>
	 * <ul>
	 * <li><b>Db setup: </b>No entity has to exist in the data base.</li>
	 * <li><b>Test: </b>That at least one new entity is being saved correctly.</li>
