...
public class ConditionAttributeVerificationChain {
	...
	public boolean verify(final List<ScopedContentConditionAttribute> attributes, final ConditionalOperator operator, final ContentOperatingContext contentDto) {
