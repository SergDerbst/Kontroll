 ...
 *
 */
public class ReadTestDataPreparerTest extends TestDataPreparerTest {

	public ReadTestDataPreparerTest() {
		super(ReadTestDataPreparer.newInstance(), TestStrategy.Read);
	}
