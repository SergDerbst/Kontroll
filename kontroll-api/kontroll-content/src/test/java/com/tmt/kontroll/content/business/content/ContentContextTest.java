...
public class ContentContextTest extends ObjectDataTest<ContentContext> {
	...
	public ContentContextTest() {
		super(new ContentContext(new ContentDto(new HashSet<RequestContextItem>(), new GlobalContextDto() {}, "requestContextPath", "scopeName"), new ArrayList<ScopedContentCondition>()));
	}
}
