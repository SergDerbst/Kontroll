...
@Button(ordinal = 2, position = ChildPosition.Bottom, name = "edit")
@Button(ordinal = 3, position = ChildPosition.Bottom, name = "add", type = ButtonType.Dropdown)
@Button(ordinal = 4, position = ChildPosition.Bottom, name = "delete")
@Dropdown(ordinal = 5, position = ChildPosition.Bottom, name = "adddropdown", itemProvider = ContentEditorAddDropdownItemProvider.class, triggers = {@Trigger("page.contentEditor.form.main.add")})
@Button(ordinal = 6, position = ChildPosition.Bottom, name = "in", events = {@Event(type = EventType.Click, handlers = {"contentItemNav"})})
@Button(ordinal = 7, position = ChildPosition.Bottom, name = "out", events = {@Event(type = EventType.Click, handlers = {"contentItemNav"})})
@Button(ordinal = 8, position = ChildPosition.Bottom, name = "up", events = {@Event(type = EventType.Click, handlers = {"contentItemNav"})})
@Button(ordinal = 9, position = ChildPosition.Bottom, name = "down", events = {@Event(type = EventType.Click, handlers = {"contentItemNav"})})
