...
public class AndConditionVerifierTest {
	...
	private AndConditionVerifier toTest;
	private List<ScopedContentCondition> childConditions;

	@Before
	public void setUp() throws Exception {
		this.toTest = new AndConditionVerifier();
	...
	@Test
	@SuppressWarnings("serial")
	public void testThatNextVerifierIsCalledWhenOperatorIsOtherThanAnd() {
		//given
		this.childConditions = new ArrayList<ScopedContentCondition>(){{
			add(childConditionTrue);
			add(childConditionFalse);
		...
		this.toTest.setNextVerifier(this.nextVerifier);
		when(this.condition.getOperator()).thenReturn(ConditionalOperator.Or);
