...
public class NotOrConditionVerifierTest {
	...
	private NotOrConditionVerifier toTest;
	private List<ScopedContentCondition> childConditions;

	@Before
	public void setUp() throws Exception {
		this.toTest = new NotOrConditionVerifier();
	...
	public void testThatVerifyReturnsFalseWhenAllConditionsAreTrue() {
		...
		when(this.condition.getOperator()).thenReturn(ConditionalOperator.NotOr);
