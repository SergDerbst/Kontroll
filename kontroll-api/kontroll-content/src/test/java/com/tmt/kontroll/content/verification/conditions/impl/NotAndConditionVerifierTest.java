...
public class NotAndConditionVerifierTest {
	...
	public void setUp() throws Exception {
		this.toTest = new NotAndConditionVerifier();
	...
	public void testThatVerifyReturnsFalseWhenAllConditionsAreTrue() {
		...
		when(this.condition.getOperator()).thenReturn(ConditionalOperator.NotAnd);
	...
	@Test
	@SuppressWarnings("serial")
	public void testThatVerifyReturnsFalseWhenOneConditionIsTrue() {
		//given
		this.childConditions = new ArrayList<ScopedContentCondition>(){{
	...
	@Test
	@SuppressWarnings("serial")
	public void testThatNextVerifierIsCalledWhenOperatorIsOtherThanNotAnd() {
		//given
		this.childConditions = new ArrayList<ScopedContentCondition>(){{
			add(childConditionTrue);
			add(childConditionFalse);
