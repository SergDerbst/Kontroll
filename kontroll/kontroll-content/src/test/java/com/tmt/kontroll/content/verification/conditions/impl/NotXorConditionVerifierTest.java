...
public class NotXorConditionVerifierTest {
	...
	private NotXorConditionVerifier toTest;
	private List<ScopedContentCondition> childConditions;

	@Before
	public void setUp() throws Exception {
		this.toTest = new NotXorConditionVerifier();
	...
	public void testThatVerifyReturnsTrueWhenAllConditionsAreTrue() {
		...
		when(this.condition.getOperator()).thenReturn(ConditionalOperator.NotXor);
